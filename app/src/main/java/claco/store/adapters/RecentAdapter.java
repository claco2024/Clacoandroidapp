package claco.store.adapters;
        ...
        import claco.store.APi.ApiResponse.recent.BeutiProduct;
        import claco.store.APi.ApiResponse.recent.HomeDecoration;
...
public class RecentAdapter extends RecyclerView.Adapter<RecentAdapter.MyViewHolder> {
    ...
    private List<BeutiProduct> productsLists;

    APiUtils.ApiCallBAck apiCallBAck;
    String title;


    public RecentAdapter(Context context, List<BeutiProduct> productsLists, APiUtils.ApiCallBAck apiCallBAck,String title) {
