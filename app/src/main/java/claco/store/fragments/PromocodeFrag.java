...
public class PromocodeFrag extends Fragment {
 ...
 TextView NoData;
    ...
    private class ProductAdapter extends RecyclerView.Adapter<FavNameHolder> {
        ...
        public void onBindViewHolder(@NonNull final FavNameHolder holder, final int position) {
            ...
            holder.tvValid.setText("Available") ;/*+ " ("+data.get(position).get("CouponId")+")"*/
    ...
    public class HitGetOffer extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            displayText = WebService.getofferlist("Promocode", "getofferlist");
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            loader.dismiss();
            Log.v("getofferlist", " getofferlist   Promocode "   + OfferFagment.from+ "    "+displayText);
