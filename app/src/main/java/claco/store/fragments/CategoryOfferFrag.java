...
public class CategoryOfferFrag extends Fragment {
   ...
   holder.tvDescription.setText("Get up to " + data.get(position).get("DiscountValue") +
    ...
    public class HitGetOffer extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            displayText = WebService.getofferlist("Category", "getofferlist");
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            loader.dismiss();
            Log.v("getofferlist"," getofferlist   Category   "+displayText);
